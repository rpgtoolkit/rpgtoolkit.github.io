...
if (rpgcode.getGlobal("haveBattled")) {
  ...
  rpgcode.loadAssets(assets, function () {
    ...
    rpgcode.setPlayerLocation("Hero", 320, 384, 0);
    rpgcode.setPlayerStance("Hero", "attackNorth");
  ...
  function doPlayerTurn() {
    ...
    if (currentSubmenu === Submenu.DEFAULT) {
      if (menuChoice === 1) {
        ...
        rpgcode.animatePlayer("Hero", "attackNorth");

        rpgcode.animateItem(0, "damage");
      ...
      if (menuChoice === 1) {
        ...
        if (healthPotions > 0) {
          rpgcode.animatePlayer("Hero", "useCure");
          playerHp += 3;
      ...
      if (menuChoice === 2) {
        ...
        if (manaPotions > 0) {
          rpgcode.animatePlayer("Hero", "useEther");
          playerMp += 3;
      ...
      if (menuChoice === 3) {
        ...
        if (powerPotions > 0) {
          rpgcode.animatePlayer("Hero", "useElixer");
          playerHp = playerMaxHp;
          playerMp = playerMaxMp;
          powerPotions -= 1;
          currentTurn = Turn.SWORD;
  ...
  function doEnemyTurn() {
    ...
    rpgcode.animatePlayer("Hero", "hurtSpin");
